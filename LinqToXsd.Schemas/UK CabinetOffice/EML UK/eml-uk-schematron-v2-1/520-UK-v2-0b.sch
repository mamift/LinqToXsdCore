...
<schema xmlns="http://www.ascc.net/xml/schematron">
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='520'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:Result">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
