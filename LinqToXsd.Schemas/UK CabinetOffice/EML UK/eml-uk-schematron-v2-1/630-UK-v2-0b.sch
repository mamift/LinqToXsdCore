...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 630 - Options List</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='630'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:OptionsList">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-630">
	</pattern>
	
	<pattern name="eml-630-uk">
	</pattern>
</schema>
