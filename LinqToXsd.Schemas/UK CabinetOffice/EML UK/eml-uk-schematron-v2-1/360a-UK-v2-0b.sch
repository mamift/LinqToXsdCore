...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 360a-Outgoing Channel Options</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='360a'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:OutgoingChannelOptions">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-360a">
	</pattern>
	
	<pattern name="eml-360a-uk">
	</pattern>
