...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 610 - Options Nomination</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='610'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:OptionsNomination">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-610">
	</pattern>

	<pattern name="EML-610-UK">
		<rule context="eml:Proposer">
			<assert id="4610-001" test="eml:Contact">Each proposer must have a contact method</assert>
		</rule>
	</pattern>
</schema>
