...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 620 - Options Nomination Response</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='620'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:OptionsNominationResponse">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-620">
		<rule context="eml:OptionsNominationResponse[eml:Accepted='no']">
			<assert id="3620-001" test="eml:Remark">If the nomination has not been accepted, a reason for rejection is required in the Remark element</assert>
		</rule>
	</pattern>
	
	<pattern name="eml-620-uk">
	</pattern>
