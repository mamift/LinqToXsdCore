        ...
        public virtual IList<string> names {
            get {
                if ((this.namesField == null)) {
                    this.namesField = new XSimpleList<string>(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, namesXName);
                }
            ...
            set {
                if ((value == null)) {
                    ...
                    if ((this.namesField == null)) {
                        this.namesField = XSimpleList<string>.Initialize(this, XmlSchemaType.GetBuiltInSimpleType(XmlTypeCode.String).Datatype, value, namesXName);
                    }
                    else {
