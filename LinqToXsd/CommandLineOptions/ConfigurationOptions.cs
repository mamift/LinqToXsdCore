...
namespace LinqToXsd
{
    ...
    {
        [Option('e', nameof(Example), HelpText = "Produce an example XML configuration file for a given XSD file. e.g. LinqToXsd config 'file.xsd' -e'. Also: optionally specify this parameter with folder paths and it will create configuration files for multiple XSD files. This will overwrite any existing configuration files.")]
