Taken from: https://docs.oasis-open.org/legalruleml/legalruleml-core-spec/v1.0/os/xsd-schema/

The specification itself has this notice:
...
According to: https://www.oasis-open.org/committees/legalruleml/charter.php
```
...
The policy is here: https://www.oasis-open.org/policies-guidelines/ipr/
And quoted below

```
OASIS OPEN Intellectual Property Rights (IPR) Policy
