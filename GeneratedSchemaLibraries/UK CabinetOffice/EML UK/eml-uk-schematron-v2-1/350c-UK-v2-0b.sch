...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 350c-Internal Generic Communication</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='350c'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:InternalGenericCommunication">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-350c">
	</pattern>
	
	<pattern name="eml-350c-uk">
	</pattern>
