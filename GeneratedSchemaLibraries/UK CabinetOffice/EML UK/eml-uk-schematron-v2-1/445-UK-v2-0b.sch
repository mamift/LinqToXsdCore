...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 445-Retrieve Vote</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='445'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:RetrieveVote">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-445">
	</pattern>

	<pattern name="eml-445-uk">
	</pattern>
</schema>
