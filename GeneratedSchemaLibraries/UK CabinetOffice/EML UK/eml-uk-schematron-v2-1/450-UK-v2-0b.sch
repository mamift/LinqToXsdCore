...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 450-Vote Confirmation</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			<assert id="3000-004" test="@Id='450'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:VoteConfirmation">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-450">
	</pattern>

	<pattern name="eml-450-uk">
		<rule context="eml:VoteConfirmation[eml:Accepted='no']">
			<assert id="4450-001" test="eml:Remark">If the value of Authenticated is "no", the reason must be given</assert>
		</rule>
	</pattern>
</schema>
