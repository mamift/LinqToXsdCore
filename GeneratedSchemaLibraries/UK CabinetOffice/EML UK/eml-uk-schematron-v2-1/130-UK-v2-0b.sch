...
<schema xmlns="http://www.ascc.net/xml/schematron">
	<title>EML-UK 130-Response</title>
	...
	<pattern name="eml">
		...
		<rule context="eml:EML">
			...
			<assert id="3000-004" test="@Id='130'">The value of the Id attribute of the EML element is incorrect</assert>
			<assert id="3000-005" test="eml:Response">The message type must match the Id attribute of the EML element</assert>
		</rule>
	</pattern>
	...
	<pattern name="eml-130">
		<rule context="eml:Response[eml:Accepted='no']">
			<assert id="3130-001" test="eml:Errors">If the message is not accepted, there must be an Errors element</assert>
		</rule>
	</pattern>
